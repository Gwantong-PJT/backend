...
@Schema(title = "HotplaceDto (핫플 정보)", description = "핫플 정보. hotplaces_tb의 내용과 동일")
@Data
public class HotplaceDto {
    ...
    @Schema(description = "핫플 게시글 제목")
    private String hotplaceTitle;

    @Schema(description = "핫플 게시글 본문")
    private String hotplaceText;

    @Schema(description = "핫플 게시글 작성 시각")
